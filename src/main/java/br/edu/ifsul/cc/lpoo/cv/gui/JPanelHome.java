...
public class JPanelHome extends JPanel {
    ...
    private void initComponents() {
        ...
        lblMensagem = new JLabel("Clínica Veterinária CosmiCare - Camila F Barcellos");
        lblMensagem.setHorizontalAlignment(SwingConstants.CENTER);
        this.add(lblMensagem, BorderLayout.NORTH);

        lblImagem = new JLabel(new ImageIcon(JPanelHome.class.getResource("/images/logo_cosmicare.png")));
        ...
        SimpleDateFormat df = new SimpleDateFormat("E, dd MMM yyyy HH:mm"); // formato extenso com dia da semana e horário

        lblData = new JLabel(df.format(c.getTime()));
        lblData.setBorder(BorderFactory.createLineBorder(Color.BLUE));
